      ...
      return (
        <Grid container justify="center">
            <Card align="center" style={{maxWidth: "65%"}}>
                <Typography style={{marginTop: "6px", fontFamily: "Barlow"}}variant="h5">
                ...
                <Typography style={{marginTop:"15px", marginBottom:"10px", marginLeft: "20px", marginRight: "20px", fontFamily: "Barlow"}} variant="subtitle1">
