        ...
        <Grid container justify="center">
            <Card align="center" style={{maxWidth: "65%"}}>
                ...
                <ButtonGroup style={{margin:"10px",marginBottom:"0px"}}size="medium"align="center" variant="contained" color="primary">
                    <Button style={{width: '80px', height:'80px', fontSize:"36px"}} onClick={this.handleDecrement}>-</Button>
                    <NumPad.Number
                        className="md-numpad"
                        decimal={true}
                        negative={false}
                    ...
                    >
                    <Button style={{width: '120px', height:'80px', fontSize:"25px", color: "black"}} disabled>{this.state.value + " " + this.props.unit}</Button>
                    </NumPad.Number>
                    <Button style={{width: '80px', height:'80px', fontSize:"36px"}} onClick={this.handleIncrement}>+</Button>
                </ButtonGroup>
                <Typography style={{marginTop:"5px", marginBottom:"40px"}} variant="subtitle1">
                    Usually this is from values of 80 to 30. :)
                </Typography>

                <Button style={{width: '250px', height:'80px', margin:"10px", fontSize:"24px", backgroundColor:"green",color:"white"}}variant="contained" onClick={this.setParameter}>Set Parameter</Button>
            </Card>
        </Grid>
      );
    }
